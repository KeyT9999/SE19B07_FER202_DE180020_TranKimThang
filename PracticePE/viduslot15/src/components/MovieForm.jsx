// MovieForm: Form thêm mới và modal chỉnh sửa phim
// - Sử dụng Context để đọc/ghi state (useMovieState/useMovieDispatch)
// - Validate dữ liệu trước khi gửi API qua Context
...
// Component con hiển thị các input field, tái sử dụng cho cả thêm mới và chỉnh sửa
...
const MovieForm = () => {
  ...
  // Đọc file ảnh và chuyển thành base64 để preview và lưu tạm vào state
  ...
  // Đóng modal chỉnh sửa và reset validate/error cục bộ
  ...
  // Validation function
  // validateForm: kiểm tra dữ liệu trước khi gửi
  const validateForm = () => {
    const newErrors = {};
  ...
  // Submit form: chuẩn hóa dữ liệu -> gọi Context CRUD -> reset/đóng modal tùy chế độ
  ...
  // Logic để tái sử dụng MovieFields cho 2 chế độ: thêm mới và chỉnh sửa
