  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.ok) {
        ...
        // Sau 2 giây → chuyển đến trang restaurants
        setTimeout(() => {
  ...
  return (
    <Container className="mt-5">
        ...
        <Col xs={12} md={6}>
          <Card className="login-card">
            <Card.Header className="text-center">
              ...
              <h3 className="mb-2">Book Eat</h3>
              <p className="text-muted mb-0">Đăng nhập để tiếp tục hành trình ẩm thực của bạn</p>
            </Card.Header>
            <Card.Body>
      ...
      <ConfirmModal
        ...
        message={`Chào mừng, ${user?.username}! Đăng nhập thành công!`}
        onHide={() => dispatch({ type: "HIDE_SUCCESS_MODAL" })}
      />
    </Container>
  );
}
